                        ...
                        <div className="rounded-xl border border-gray-700 bg-gray-900/50 shadow-lg p-4">
                            ...
                            <div className="flex justify-center gap-4">
                                ...
                                <button
                                    aria-label="Next"
                                    onClick={nextSlide}
                                    className="px-4 py-2 rounded-md bg-red-600 text-white font-semibold hover:bg-red-7
                                    00 transition transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-red-400"
                                >
                                    Next
                                </button>
                            </div>
