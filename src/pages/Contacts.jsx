...
const Contacts = () => {
  return (
    <main className="bg-black bg-opacity-90 min-h-screen animate-fade-in font-montserrat text-white py-32 border-t-4 border-b-4 border-white">
      <div className="w-full py-12 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="text-center mb-12 relative">
            ...
            {/* Contact Icons Grid */}
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 max-w-4xl mx-auto relative bg-black bg-opacity-70 rounded-lg p-6 border-2 border-emerald-900 shadow-lg">
          ...
          <section className="py-8 sm:py-12 grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 max-w-7xl mx-auto">
            ...
            <div>
              <h2
                className="text-3xl font-semibold text-white text-center mb-8 border-b-2 border-emerald-900 pb-2"
              >
                Send us a Message
              </h2>
              <div className="bg-black bg-opacity-80 rounded-lg border-4 border-emerald-900 shadow-xl relative">
                ...
                <form className="p-8 space-y-6 flex flex-col min-h-[400px]">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        type="text"
                        id="name"
                        className="w-full bg-black bg-opacity-70 text-white px-4 py-2 rounded-md border border-white focus:ring-2 focus:ring-amber-500 focus:outline-none"
                        required
                      />
                    </div>
                    <div>
                  ...
                  <button
                    type="submit"
                    className="w-full bg-emerald-900 text-white px-6 py-3 rounded-lg font-semibold hover:bg-amber-600 hover:scale-105 transition-transform duration-300 border-2 border-white shadow-lg focus:ring-2 focus:ring-amber-500 focus:outline-none"
                  >
                    Send Message
                  </button>
                </form>
            ...
            {/* Map */}
            <div className="bg-black bg-opacity-80 rounded-xl overflow-hidden border-2 border-emerald-900 shadow-xl">
              <iframe
          ...
          <section className="text-center py-8 sm:py-12">
            <h2
              className="text-3xl font-bold text-white mb-4 border-b-2 border-emerald-900 pb-2"
            >
              Visit Us Today
            </h2>
