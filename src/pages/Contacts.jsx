...
const Contacts = () => {
  return (
    <main className="bg-black bg-opacity-90 min-h-screen animate-fade-in font-montserrat text-white py-16 border-t-4 border-b-4 border-white">
          ...
          <section className="text-center mb-12 relative">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 max-w-4xl mx-auto relative bg-black bg-opacity-70 rounded-lg p-6 border-2 border-white shadow-lg">
              <div className="flex flex-col items-center">
                <FaMapMarkerAlt className="text-4xl text-amber-400 mb-2" />
                <h3 className="text-xl font-semibold text-white">Our Address</h3>
                <p className="text-gray-400 text-center">#275 Ugwogo Nike Road, Abakpa, Enugu</p>
              </div>
              <div className="flex flex-col items-center">
                <FaPhoneAlt className="text-4xl text-amber-400 mb-2" />
                <h3 className="text-xl font-semibold text-white">Phone</h3>
                <a href="tel:+2349162836505" className="text-amber-400 hover:text-amber-500 transition-colors">
                  0916 283 6505
                </a>
              </div>
              <div className="flex flex-col items-center">
                <FaEnvelope className="text-4xl text-amber-400 mb-2" />
                <h3 className="text-xl font-semibold text-white">Email</h3>
                <a href="mailto:odogwucally@gmail.com" className="text-amber-400 hover:text-amber-500 transition-colors">
